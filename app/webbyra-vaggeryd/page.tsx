...
export const metadata: Metadata = {
  title: "Webbyrå Vaggeryd | Webbdesign & SEO | Staark Inc.",
  description:
    "Webbyrå i Vaggeryd för företag som vill växa online. Vi hjälper dig med webbdesign, SEO och moderna hemsidor. Få en kostnadsfri offert.",
};

export default function VaggerydPage() {
  return (
    <main>
      {/* HERO */}
      <section>
        <p>WEBBYRÅ I VAGGERYD</p>
        ...
        <p>
          Staark hjälper företag i Vaggeryd att bygga snabba,
      ...
      {/* LOCAL */}
      <section>
        <h2>En lokal webbyrå för företag i Vaggeryd</h2>

        <p>
          Driver du företag i Vaggeryd och behöver en ny hemsida

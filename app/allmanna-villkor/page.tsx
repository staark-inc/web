    ...
    <StandaloneLayout>
      <main className="legal-page">
        <div className="legal-shell">
          ...
          <section><h2>1. Tillämpning</h2><p>Dessa villkor gäller för tjänster som Staark Inc. levererar om inget annat har avtalats skriftligen. En specifik offert, orderbekräftelse eller separat överenskommelse har företräde framför dessa allmänna villkor om uppgifterna skiljer sig åt.</p><p>Villkoren är i första hand utformade för företagskunder. Om kunden är konsument gäller alltid tvingande konsumentskyddsregler framför villkor som skulle ge sämre rättigheter.</p></section>

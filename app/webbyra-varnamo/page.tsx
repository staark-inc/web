...
export const metadata: Metadata = {
  title: "Webbyrå Värnamo | Webbdesign & SEO | Staark Inc.",
  description:
    "Webbyrå i Värnamo för företag som vill växa online. Vi hjälper dig med webbdesign, SEO och moderna hemsidor. Få en kostnadsfri offert.",
};

export default function VarnamoPage() {
  return (
    <main>
      {/* HERO */}
      <section>
        <p>WEBBYRÅ I VÄRNAMO</p>
        ...
        <p>
          Staark hjälper företag i Värnamo att bygga snabba,
      ...
      {/* LOCAL */}
      <section>
        <h2>En lokal webbyrå för företag i Värnamo</h2>

        <p>
          Driver du företag i Värnamo och behöver en ny hemsida
